...
public class Subtitle {
    ...
    private final byte SUP_o_CHARACTER           =    (byte) 0xEB;    // caracter º
    private final byte SUP_a_CHARACTER           =    (byte) 0xE3;    // caracter ª
    ...
    public void decodeTextSTL() throws Exception {
        ...
        for (; i< this._lenTextFieldTTIsubtitle; i++){
            ...
            if (b==this.FILLER_CHARACTER){
                //continue;
                //-- final del subtitulo, añadimos el texto encontrado a una linea y salimos
                byte odef[] = new byte[nout];
                System.arraycopy(out, 0, odef, 0, nout);
                String line = new String(odef);
                alines.add(line);
